...
/opt/langgraph-venv/bin/pip install --no-cache-dir /workspace/langgraph-service/
...
echo "  3. cd langgraph-service && uvicorn src.main:app --reload --host 0.0.0.0 --port 5050"
